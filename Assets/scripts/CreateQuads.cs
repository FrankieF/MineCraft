...
public class CreateQuads : MonoBehaviour {
    ...
    void CombineQuads()
    {
        // combine all the children meshes
        ...
        // New mesh on the parent object
        MeshFilter meshFilter = (MeshFilter)this.gameObject.AddComponent(typeof(MeshFilter));
        meshFilter.mesh = new Mesh();

        // Add combinsed meshes on children as parent mesh
        meshFilter.mesh.CombineMeshes(combine);

        // Create renderer for parent and delete all uncombined children
